    ...
    <div class="container-fluid"> <!-- Usar todo el body -->
      ...
      <div class="row ">           <!-- Generar columnas, sistema de rejillas -->
        ...
        <!-- <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3"> -->
          ...
          <!-- / .main-navbar -->
          <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
            <div class="main-content-container container-fluid px-4" style="background-image: url('{{ asset('images/fondo3it.png') }}'); height: 100vh; background-size: cover; background-position: center;}" >
