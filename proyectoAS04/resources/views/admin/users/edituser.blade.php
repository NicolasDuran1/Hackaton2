                        ...
                        <div class="col">
                            ...
                            <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="rut" value="{{Auth::user()->rut}}" disabled> 
                              </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Email</label>
                                <input type="email" class="form-control" name="email" placeholder="Email" value="{{Auth::user()->email}}"> </div>
                              <div class="form-group col-md-6">
                                <label for="password">Contraseña</label>
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{Auth::user()->password}}" >
                              ...
                              <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="universidad" id="universidad" class="form-control" placeholder="Universidad" value="{{Auth::user()->universidad}}" >
                                            <option selected value="{{Auth::user()->universidad}}"> {{ $univ->nombre_universidad }} </option>
